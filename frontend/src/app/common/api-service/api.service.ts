...
export class ApiService {
  ...
  public BASEURL: string = 'http://localhost:8080/login/backend';
  public BASE_UPLOAD_URL: string = 'http://localhost:8080/login/backend/P5Upload';

  // public SERVER_URL = this.BASEURL + '/Controller/Upload.php';
  public SENTMAIL_URL = 'https://rolievn.com/api/Controller/BaseMail.php';
  public IMAGE_UPLOAD_URL = this.BASEURL + '/P5Upload/UploadImage.php';
  public FILE_UPLOAD_URL = this.BASEURL + '/P5Upload/UploadFile.php';
