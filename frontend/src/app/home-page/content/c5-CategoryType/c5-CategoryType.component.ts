...
@Component({                                                                
  selector: 'app-c5-CategoryType',                                                
  templateUrl: './c5-CategoryType.component.html',                                
  styleUrls: ['./c5-CategoryType.component.scss'],                                
})                                                                          
export class C5CategorytypeComponent implements OnInit, AfterViewInit, OnDestroy {  
  ...
  */
  ...
  onBtnInsertDataClick() {
    const dialogRef = this.dialog.open(C5CategorytypeDialog, {
      width: '100%',
      height: '100%',
      maxWidth: '100%',
      maxHeight: '100%',
 ...
 */
@Component({                                              
  selector: 'c5-CategoryType-dialog',                            
  templateUrl: 'c5-CategoryType-dialog.html',                    
  styleUrls: ['./c5-CategoryType.component.scss'],               
})                                                        
export class C5CategorytypeDialog implements OnInit, OnDestroy {  
   ...
   */
  constructor(
    public dialogRef: MatDialogRef<C5CategorytypeDialog>,
  ...
  onBtnSubmitClick(): void {
    ...
    this.input.createdAt = this.api.formatDate(new Date(this.input.createdAt)); 
    this.input.updatedAt = this.api.formatDate(new Date(this.input.updatedAt)); 
